...
_C.MODEL.WEIGHTS = ""
# specify this to load from specific checkpoint
_C.MODEL.RESUME_ITER = -1
...
_C.DATASETS.TEST = ()
# when not train, just eval on dataset, use this
_C.DATASETS.EVAL = ()
...
# cervix data path config
_C.DATASETS.CERVIX_IMG_DIR = '/data/lxc/Cervix/paper_data/imgs'
_C.DATASETS.CERVIX_SPLIT_PATH_TRAIN = '/data/lxc/Cervix/paper_data/data_split/det/sil/train.txt'
_C.DATASETS.CERVIX_SPLIT_PATH_VALID = '/data/lxc/Cervix/paper_data/data_split/det/sil/valid.txt'
_C.DATASETS.CERVIX_SPLIT_PATH_TEST = '/data/lxc/Cervix/paper_data/data_split/det/sil/test.txt'
_C.DATASETS.CERVIX_ANNO_PATH = '/data/ctt/data/CervixData/paper_data/annos_hsil_norm.pkl'
_C.DATASETS.CERVIX_DATA_TYPE = 'acid'
_C.DATASETS.CERVIX_LABEL_TYPE = 'sil'  # sil (lsil and hsil) or hsil (hsil only)
...
_C.MODEL.RETINANET.CAM_NUM_CLASSES = 2
...
# evaluation max detection per image
_C.TEST.MAX_DETS = [1, 2, 3, 5, 10, 100, float('inf')]
